                ...
                <Content>
                    <Card style={styles.tCard}>
                        <CardItem style={{alignItems: 'center'}}>
                                ...
                                <View style={styles.thanksText3}>
                                    <Text style={{ backgroundColor: '#81cdc7', borderRadius: 10, fontSize: 12, paddingLeft: 8, paddingRight: 8, paddingTop: 2, paddingBottom: 2 }}>
                                        ORDER #: {this.props.navigation.state.params.orderId?this.props.navigation.state.params.orderId:''}
                                    </Text>
                                </View>
