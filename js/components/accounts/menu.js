...
import { Image, View, StatusBar, Dimensions, Alert, TouchableOpacity, BackHandler, AsyncStorage, Text } from "react-native";

import { Container, Header, Button, Content, Form, Item, Icon, Frame, Input, Label , CardItem, Right, Card, Left, Body, Title } from "native-base";
